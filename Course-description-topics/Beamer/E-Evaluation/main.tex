...
\begin{frame}{Overview}
    \begin{enumerate}
        ...
        \begin{itemize}
            \item E03: Accuracy (accuracy)
            \item E04: Precision (precision)
            \item E05: Recall / Sensitivity (sensitivity)
            \item E06: Specificity (specificity)
        \end{itemize}
...
% E01
% ---------------------------------------------------------------------
\begin{frame}{E01: Interpret en Confusion Matrix (confusion matrix)}
...
% E03
% ---------------------------------------------------------------------
\begin{frame}{E03: Accuracy (accuracy)}
    ...
    \begin{alertblock}{Warning}
        Høy accuracy kan være misvisende ved ubalanserte dataset!
    \end{alertblock}
...
% E04
% ---------------------------------------------------------------------
\begin{frame}{E04: Precision (precision / PPV)}
...
% E05
% ---------------------------------------------------------------------
\begin{frame}{E05: Recall / Sensitivity (sensitivity)}
...
% E06
% ---------------------------------------------------------------------
\begin{frame}{E06: Specificity (specificity)}
...
\begin{frame}{E10: \href{https://www.tripod-statement.org/}{TRIPOD}-retningslinjer}
    ...
    \begin{columns}
        \begin{column}{0.48\textwidth}
            \begin{enumerate}
                \item Tydelig describelse av studiepopulasjon
    ...
    \begin{alertblock}{Why viktig?}
        TRIPOD sikrer \textbf{reproduserbarhet} og \textbf{kvalitetskontroll} av prediksjonsmodor i helseforskning.
    \end{alertblock}
