...
% =====================================================================
% SEKSJON: MRI Fundamentals
% =====================================================================
\section{MRI Fundamentals}

\begin{frame}{B01: Explain fundamental MRI-prinsipper på et overordnet nivå}
    ...
    \vspace{0.3cm}
    \textbf{Why MRI er viktig i medisin:}
    \begin{columns}[T]
...
\begin{frame}{B02: Know about ulike MR-sekvenser (T1, T1+Gd, T2, FLAIR)}
...
% =====================================================================
% SEKSJON: Segmentation
% =====================================================================
\section{Segmentation}

\begin{frame}{B03: Describe segmentation i medisinsk image analysis}
    \textbf{Segmentation = identifisere og avgrense strukturer i bilde}
...
\begin{frame}{B04: Know about BraTS-utfordringen for hjernesvulstsegmentation}
...
% =====================================================================
% SEKSJON: Quantitative Imaging
% =====================================================================
\section{Quantitative Imaging}

\begin{frame}{B05: Describe radiomic features og kvantitativ avbildning}
    \textbf{\href{https://pyradiomics.readthedocs.io/}{Radiomics} = kvantifisering av bildeegenskaper}
    
    \vspace{0.3cm}
    \textbf{What is radiomic features?}
    \begin{itemize}
        \item Matematisk describelse av tekstur, form, intensitet i bildet
...
\begin{frame}{B06: Know about nnU-Net og MONAI som verktøy}
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            \textbf{nnU-Net:}
            \begin{itemize}
...
\begin{frame}{Summary: Medical Image Analysis}
    ...
    \begin{block}{\footnotesize Lab 2}
        \footnotesize Praktisk erfaring med CNN for image analysis, inkludert medisinsk applylse (MR-demens).
    \end{block}
\end{frame}
