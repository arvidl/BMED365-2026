...
\begin{frame}{G04: Explain hva \href{https://en.wikipedia.org/wiki/Lexical_analysis\#Token}{tokens} er og how \href{https://en.wikipedia.org/wiki/Tokenization_(lexical_analysis)}{tokenisering} fungerer}
    ...
    \begin{itemize}
        ...
        \item Token $\approx$ subword, approx. 4 characters per token (for English/Norwegian)
    \end{itemize}
...
\begin{frame}{G10: Describe god praksis for \href{https://en.wikipedia.org/wiki/Prompt_engineering\#System_prompts}{systemprompts}}
    ...
    \begin{enumerate}
        ...
        \item \textbf{Format:} ``Reply in Norwegian, use bullet points...''
    \end{enumerate}

    \vspace{0.15cm}
    \begin{block}{\footnotesize Example på systemprompt}
        \scriptsize
        \texttt{You are a medical AI assistant for healthcare professionals. Reply in Norwegian. Be precise and evidence-based. Reference sources when possible. Never give definitive diagnoses -- suggest differential diagnoses. When uncertain, say so.}
    \end{block}
