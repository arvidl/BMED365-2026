...
% =====================================================================
% SEKSJON: Biological vs. Artificial Neurons
% =====================================================================
\section{Basic Neural Networks}

\begin{frame}{D01: Compare biologiske og kunstige nevroner}
    \begin{columns}[T]
    ...
    \begin{alertblock}{Important difference}
        Kunstige nevroner er \textbf{kraftig forenklede modor} -- de fanger ikke hjernens fulle kompleksitet.
    \end{alertblock}
\end{frame}

\begin{frame}{D02: Describe oppbygningen av et multilags perseptron (MLP)}
    \begin{columns}[T]
        \begin{column}{0.55\textwidth}
            \textbf{MLP-arkitektur:}
            \begin{itemize}
                \item \textbf{Inputlag:} Mottar features (ikke prosessering)
                \item \textbf{Skjulte lag:} 1 or flere lag med nevroner
...
\begin{frame}{D03: Explain hva en aktiveringsfunksjon er (ReLU, sigmoid)}
    \textbf{Why aktiveringsfunksjoner?} Uten dem: Hele nettverket = lineær transformasjon. Introduserer \textbf{ikke-linearitet}.
    ...
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            ...
            \begin{itemize}
                ...
                \item Brukes i output for binær classification
            \end{itemize}
        \end{column}
        \begin{column}{0.48\textwidth}
...
% =====================================================================
% SEKSJON: Training Neural Networks
% =====================================================================
\section{Training Neural Networks}

\begin{frame}{D04: Understand konseptet forward propagation}
    ...
    \begin{block}{Key point}
        Forward propagation calculater prediksjon -- ingen læring skjer her. Læring skjer ved backpropagation og oppdatering av vekter.
    \end{block}
\end{frame}

\begin{frame}{D05: Explain backpropagation på et konseptuelt nivå}
    ...
    \begin{alertblock}{Intuisjon}
        Tenk deg at du justerer en kompleks maskin: Backpropagation fortor deg hvilke skruer (vekter) du shall skru på, og i hvilken retning, for å forbedre resultatet.
    \end{alertblock}
...
\begin{frame}{D06: Understand gradient descent og læringsrate}
    ...
    \begin{block}{\footnotesize Epoch}
        \footnotesize En \textbf{epoch} = én gjennomgang av hele trainingsdatasetet
    \end{block}
\end{frame}
...
\begin{frame}{D07: Know about loss functions (cross-entropy, MSE)}
    ...
    \begin{itemize}
        ...
        \item Målet: Minimere loss under training
    \end{itemize}
...
% =====================================================================
% SEKSJON: Convolutional Neural Networks
% =====================================================================
\section{Convolutional Neural Networks (CNN)}

\begin{frame}{D08: Describe et konvolusjonelt nevralt nettverk (CNN)}
...
\begin{frame}{D09: Explain hva et konvolusjonsfilter gjør}
    \textbf{Konvolusjonsfilter (kernel):}
    \begin{itemize}
        \item Liten matrise (f.eks. $3 \times 3$) som \textbf{glir over bildet}
        \item Calculater punktprodukt mellom filter og bildepatch
...
\begin{frame}{D10: Describe pooling-lag og deres funksjon}
    \textbf{Pooling = nedshallering av feature maps}
...
\begin{frame}{D11: Know about batch normalization og dropout}
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            \textbf{Batch Normalization:}
            \begin{itemize}
                \item Normaliserer aktiveringer i hvert mini-batch
                \item $\hat{x} = \frac{x - \mu}{\sigma}$, deretter shaller/skift
                \item Advantages:
                \begin{itemize}
                    \item Raskere training
        ...
        \begin{column}{0.48\textwidth}
            ...
            \begin{itemize}
                ...
                \end{itemize}
                \item Brukes kun under training!
            \end{itemize}
        \end{column}
    \end{columns}
    ...
    \begin{block}{Regulariseringsteknikker}
        Både batch normalization og dropout hjelper med å unngå overfitting og forbedre generaliseringsevne.
    \end{block}
\end{frame}

\begin{frame}{D12: Understand konseptet transfer learning}
    ...
    \vspace{0.3cm}
    \begin{alertblock}{\footnotesize Why fungerer det?}
    ...
    \begin{block}{\footnotesize Example i medisin}
...
\begin{frame}{D13: Know about advanced arkitekturer (ResNet, ViT)}
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            ...
            \vspace{0.2cm}
            \textbf{Important bidrag:}
            \begin{itemize}
                \item Løste problemet med degradering i dype nettverk
                \item Standard for medisinsk image analysis
            \end{itemize}
        \end{column}
        \begin{column}{0.48\textwidth}
            \textbf{ViT (Vision Transformer):}
            \begin{itemize}
                \item Applyr transformer-arkitektur på bilder
            ...
            \textbf{Moderne trend:}
            \begin{itemize}
                \item Overgår CNN på store dataset
                \item Brukes i state-of-the-art modor
            \end{itemize}
        \end{column}
    \end{columns}
    ...
    \begin{block}{Andre viktige arkitekturer}
        \textbf{U-Net}: Segmentation (medisinsk klassiker) | \textbf{EfficientNet}: Balansert shallering | \textbf{DenseNet}: Tette koblinger
    \end{block}
\end{frame}
...
\begin{frame}{Summary: Deep Learning}
    ...
    \begin{block}{Lab 2 -- Praktisk erfaring}
        Bygg, tren og evaluer CNN med PyTorch. Bruk Grad-CAM for å understand modellbeslutninger.
    \end{block}
\end{frame}
