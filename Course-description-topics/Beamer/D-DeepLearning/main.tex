    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.42\textwidth}
            \begin{tikzpicture}[scale=0.7, transform shape]
                ...
                \node[neuron] (i3) at (0, -3) {};
                \node at (0, -4.2) {\footnotesize Input};
                
                % Hidden layer 1
                \node[neuron, fill=uibblue!40] (h1a) at (2, -0.5) {};
                \node[neuron, fill=uibblue!40] (h1b) at (2, -1.5) {};
                \node[neuron, fill=uibblue!40] (h1c) at (2, -2.5) {};
                \node[neuron, fill=uibblue!40] (h1d) at (2, -3.5) {};
                \node at (2, -4.7) {\footnotesize Hidden 1};
                
                % Hidden layer 2
                \node[neuron, fill=uibblue!60] (h2a) at (4, -1) {};
                \node[neuron, fill=uibblue!60] (h2b) at (4, -2) {};
                \node[neuron, fill=uibblue!60] (h2c) at (4, -3) {};
                \node at (4, -4.2) {\footnotesize Hidden 2};
                
                % Output layer
                \node[neuron, fill=uibred!40] (o1) at (6, -1.5) {};
                \node[neuron, fill=uibred!40] (o2) at (6, -2.5) {};
