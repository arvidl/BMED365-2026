...
\begin{frame}{Overview}
    \begin{enumerate}
        \item \textbf{Fundamental om PSN}
        \begin{itemize}
            \item P01: Explain konseptet patient similarity networks (PSN)
            \item P02: Describe hvordan PSN kan støtte precisionsmedisin
        \end{itemize}
        \item \textbf{Likhetsberegning}
        \begin{itemize}
            \item P03: Calculate likhet (similaritet) mellom pasienter
        ...
        \end{itemize}
        \item \textbf{Advanced temaer}
        \begin{itemize}
            \item P07: Advantages og begrensninger ved PSN-tilnærmingen
...
% =====================================================================
% SEKSJON: Fundamental om PSN
% =====================================================================
\section{Fundamental om PSN}

\begin{frame}{P01: Explain konseptet \href{https://en.wikipedia.org/wiki/Patient_similarity_network}{patient similarity networks (PSN)}}
    \begin{columns}[T]
        \begin{column}{0.55\textwidth}
            \textbf{What is et patient similarity networks?}
            \begin{itemize}
                \item En \textbf{graf} der hver node representerer en pasient
                \item \textbf{Kanter} forbinder pasienter som ligner hverandre
                \item Likhet basert på kliniske variabler (symptomer, vitalia, demografi), biomarkører, genethics, avbildning, livsstilsfaktorer
            \end{itemize}
...
\begin{frame}{P02: Describe hvordan PSN kan støtte \href{https://en.wikipedia.org/wiki/Precision_medicine}{precisionsmedisin}}
    ...
    \vspace{0.3cm}
    \textbf{PSN støtter precisionsmedisin ved å:}
    \begin{enumerate}
...
\begin{frame}{P03: Calculate likhet (\href{https://en.wikipedia.org/wiki/Similarity_measure}{similaritet}) mellom pasienter}
    ...
    \begin{columns}[T]
        \begin{column}{0.58\textwidth}
            ...
            \begin{enumerate}\setlength{\itemsep}{0pt}
                ...
                \item Rask og shallerbar
            \end{enumerate}
            
            \vspace{2mm}
            \textbf{Clinical tolkning:}
            \begin{itemize}\setlength{\itemsep}{0pt}
...
% =====================================================================
% SEKSJON: Advanced temaer
% =====================================================================
\section{Advanced temaer}

\begin{frame}{P07: Advantages og begrensninger ved PSN-tilnærmingen}
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
        ...
        \begin{column}{0.48\textwidth}
            ...
            \begin{itemize}
                ...
                \item \faTimes~Skalerer dårlig til store dataset
...
\begin{frame}{Summary: PSN}
    ...
    \begin{itemize}
        ...
        \item \textbf{P02:} Støtter precisionsmedisin via subgruppeidentifikasjon
        ...
        \item \textbf{P07:} Advantages vs. begrensninger må avveies
