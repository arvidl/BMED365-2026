...
\begin{frame}{Overview}
    \begin{enumerate}
        ...
        \begin{itemize}
            \item N01: What is en graf? (Noder og kanter)
...
% N01
% ---------------------------------------------------------------------
\begin{frame}{N01: What is en graf? (Noder og kanter)}
...
\begin{frame}{N02: Rettet vs. ikke-rettet graf}
    ...
    \begin{columns}
        ...
        \begin{column}{0.48\textwidth}
            ...
            \begin{itemize}
                ...
                \item $A \rightarrow B \neq B \rightarrow A$
                \item Example: Gen-regulatoriske nettverk
            \end{itemize}
    ...
    \begin{block}{\footnotesize Medical kontekst}
        \footnotesize PSN (patient similarity networks) er vanligvis \textbf{ikke-rettet}: likhet mellom pasient A og B er symmetrisk.
    \end{block}
...
\begin{frame}{N03: Vektet vs. ikke-vektet graf}
    ...
    \begin{block}{I PSN (patient similarity networks)}
        \footnotesize
        Vekten representerer \textbf{likhet (similaritet)} mellom pasienter, calculatet fra kliniske variabler.\\[2pt]
...
\begin{frame}{N05: \href{https://en.wikipedia.org/wiki/Degree_centrality}{Degree Centrality} (grad-sentralitet)}
    ...
    \begin{block}{\footnotesize Medical relevans}
...
\begin{frame}{N07: \href{https://en.wikipedia.org/wiki/Eigenvector_centrality}{Eigenvector Centrality} (egenvektor-sentralitet)}
    ...
    \begin{columns}
        \begin{column}{0.55\textwidth}
            ...
            \begin{itemize}
                \item Degree: tor bare antall naboer
