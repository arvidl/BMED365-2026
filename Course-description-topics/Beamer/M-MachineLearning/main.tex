...
% M01
% ---------------------------------------------------------------------
\begin{frame}{M01: Define \href{https://en.wikipedia.org/wiki/Machine_learning}{machine learning} og skille fra tradisjonell programmering}
    ...
    \begin{columns}
        ...
        \begin{column}{0.48\textwidth}
            ...
            \begin{block}{\scriptsize Definition (Tom Mitchell, 1997) -- på norsk}
                \scriptsize
...
\begin{frame}{M02: \href{https://en.wikipedia.org/wiki/Supervised_learning}{Supervised} vs. \href{https://en.wikipedia.org/wiki/Unsupervised_learning}{Unsupervised} læring}
    ...
    \begin{columns}
        \begin{column}{0.48\textwidth}
            ...
            \begin{itemize}
                ...
                \item Medical: Diagnostisering, prognose
    ...
    \begin{block}{\footnotesize \href{https://en.wikipedia.org/wiki/Semi-supervised_learning}{Semi-supervised} (delvis veiledet) -- prinsipper og applylser}
        ...
        \textbf{Applications:} Medical bildesegmentation, tekstclassification, talegjenkjenning, legemiddeloppdagelse, genomikk.
    \end{block}
...
\begin{frame}{M03: \href{https://en.wikipedia.org/wiki/Feature_(machine_learning)}{Features} (input) og \href{https://en.wikipedia.org/wiki/Labeled_data}{Labels} (output)}
    ...
    \vspace{2mm}
    \textbf{Example -- Hjertesykdomsprediksjon (tabulære data):}
...
\begin{frame}{M04: Why \href{https://en.wikipedia.org/wiki/Training,_validation,_and_test_data_sets\#Training_data_set}{training set} og \href{https://en.wikipedia.org/wiki/Training,_validation,_and_test_data_sets\#Test_data_set}{test set}?}
    ...
    \textbf{Problemet:} How vet vi om modellen generaliserer til nye data?
...
\begin{frame}{M05: \href{https://en.wikipedia.org/wiki/Overfitting}{Overfitting (Overfitting)} og \href{https://en.wikipedia.org/wiki/Overfitting\#Underfitting}{Underfitting (Underfitting)}}
    ...
    \begin{block}{\footnotesize Kjennetegn på overfitting}
        \footnotesize Stor forskjell mellom trainings- og test-\href{https://en.wikipedia.org/wiki/Evaluation_of_machine_learning_models}{ytelse} (performance). \textbf{Ytelse} = mål på hvor godt modellen presterer (f.eks. accuracy, F1).
    \end{block}
...
% =====================================================================
\section{Validation og modelltyper}
% =====================================================================
...
\begin{frame}{M07: \href{https://en.wikipedia.org/wiki/Cross-validation_(statistics)\#k-fold_cross-validation}{K-fold cross-validation}}
    ...
    \begin{enumerate}
        ...
        \item Gjennomsnitt av alle $k$ evaluationer
    \end{enumerate}
...
\begin{frame}{M08: \href{https://en.wikipedia.org/wiki/Baseline_(machine_learning)}{Baseline model}}
    ...
    \begin{block}{\footnotesize What is en baseline?}
    ...
    \begin{itemize}
        ...
        \end{itemize}
        \item \textbf{Regression:} Prediker alltid gjennomsnittsverdien
        \item \textbf{Tidsserie:} Bruk forrige verdi som prediksjon
    \end{itemize}

    \vspace{2mm}
    \begin{alertblock}{\footnotesize Why viktig?}
        \footnotesize
        90\% accuracy høres imponerende ut, men ikke hvis baseline er 90\%! Viser om ML tilfører \textbf{faktisk verdi}. Avslører ubalanserte dataset.
    \end{alertblock}
...
% M10
% ---------------------------------------------------------------------
\begin{frame}{M10: Enkle ML-modor}
    ...
    \begin{block}{Tip}
        Start alltid med enkle modor før du prøver komplekse!
    \end{block}
...
\begin{frame}{Summary: M01--M10}
    ...
    \begin{columns}
        ...
        \begin{column}{0.34\textwidth}
            ...
            \begin{itemize}\setlength{\itemsep}{0pt}
                ...
                \item Multimodale modor (tekst+bilde)
    ...
    \vspace{0mm}
    \begin{block}{\scriptsize Medical relevans -- ML-applylser i helse, medisin og bioteknologi}
        \scriptsize
        ...
        \textbf{Folkehelse:} Epidemiologisk modoring, vaksinestrategi, sosiale determinanter, helseøkonomi (QALY/DALY).
    \end{block}
