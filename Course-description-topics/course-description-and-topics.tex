...
\begin{tikzpicture}[node distance=1.4cm, auto]
    ...
    \node [block, below=of genai] (team) {Team Project};
...
The course is organized around four laboratories (Labs), a quick start course, and a team project. Table~\ref{tab:activities} provides an overview.
...
\begin{description}
    ...
    \item[MittUiB:] \url{https://mitt.uib.no/courses/50716} (enrolled only)
\end{description}
