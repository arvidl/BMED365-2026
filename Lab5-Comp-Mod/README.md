...
|  [03-compmod-fine-tuning.ipynb](https://nbviewer.jupyter.org/github/arvidl/BMED365-2026/blob/main/Lab5-Comp-Mod/MLX-Bio-Qwen/notebooks/03-compmod-fine-tuning.ipynb)<br> Fine-tuning Qwen 2.5 72B Instruct locally — LoRA/QLoRA adaptation on Apple Silicon for domain-specific tasks in computational medicine, neurodynamics, and biomedical physics | [![Google Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/arvidl/BMED365-2026/blob/main/Lab5-Comp-Mod/MLX-Bio-Qwen/notebooks/03-compmod-fine-tuning.ipynb)|
