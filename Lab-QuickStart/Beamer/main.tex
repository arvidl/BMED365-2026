...
\begin{frame}{The Jupyter Notebook Environment}
    \begin{columns}
        \column{0.5\textwidth}
        ...
        \end{enumerate}
        This promotes \textit{reproducible research}.
...
\begin{frame}[fragile]{Markdown and LaTeX in Jupyter}
...
\begin{frame}{NumPy: Numerical Python}
...
\begin{frame}[fragile]{Pandas: Data Processing}
...
\begin{frame}{Matplotlib \& Seaborn: Visualization}
    \begin{itemize}
...
pd.read_csv?
        \end{lstlisting}
        \item \textbf{Restart Kernel:} If things get stuck, restart the kernel (Kernel -> Restart).
    \end{itemize}
\end{frame}

\begin{frame}{The Road Ahead}
    When you are finished with the quick start, you are ready for \textbf{Lab 0}, where we will begin with real machine learning using PyCaret.
