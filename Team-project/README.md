...
| Team 2 | 2 (b04, b05)      | 3 (e05, e06, e18)      | 5     |
...
> 📌 **Please note:** The task is to **write a research plan** (a grant proposal sketch) for a hypothetical project, **not** to actually conduct the project with data analysis or coding. You should describe *what* you would do, *how* and *why*, but not perform the actual analysis.
